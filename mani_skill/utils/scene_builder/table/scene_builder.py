...
class SimpleTableSceneBuilder(SceneBuilder):
    def build(self):
        ...
        # table_box_size = (2.418 / 2, 1.209 / 2, 0.9196429 / 2)
        self.table_box_size = (1.8288 / 2, 0.9144 / 2, 0.6 / 2)
        
        builder.add_box_collision(
            pose=sapien.Pose(p=[0, 0, self.table_box_size[2]]),
            half_size=self.table_box_size,
        )
        ...
        self.table_length = self.table_box_size[0] * 2
        self.table_width = self.table_box_size[1] * 2
        self.table_height = self.table_box_size[2] * 2
        floor_width = 100
