...
def main(episode_idx, path_to_demo_root_dir, demo_name, dino_model_string, desired_dinov2_size):
    ...
    x_norm_clstoken_array_name = episode_data_dinov2_group_name + '/x_norm_clstoken'
    ...
    x_norm_regtokens_array_name = episode_data_dinov2_group_name + '/x_norm_regtokens'
    ...
    x_norm_patchtokens_array_name = episode_data_dinov2_group_name + '/x_norm_patchtokens'
